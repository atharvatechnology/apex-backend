...
urlpatterns = [
    ...
    path("list/", BannerAdListAPIView.as_view(), name="bannerad-list"),
    path(
        "retrieve/<int:pk>/",
        BannerAdRetrieveAPIView.as_view(),
        name="bannerad-retrieve",
    ),
    path("update/<int:pk>/", BannerAdUpdateAPIView.as_view(), name="bannerad-update"),
    path("delete/<int:pk>/", BannerAdDeleteAPIView.as_view(), name="bannerad-delete"),
]
